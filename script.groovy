def incrementVersion() {
    ...
    sh 'mvn build-helper:parse-version versions:set -DnewVersion=${parsedVersion.majorVersion}.' +
       '${parsedVersion.minorVersion}.$((${parsedVersion.nextIncrementalVersion})) versions:commit' //building the java maven app using incremental versioning maj:min:patch
